...
lazy val root = project.in(file("."))
  ...
  .settings(
    ...
    Compile / mainClass := Some("org.wongiseng.backend.Launcher")
  )
...
lazy val frontend = project.in(file("frontend"))
  ...
  .settings(
    ...
    Compile / mainClass := Some("org.wongiseng.frontend.JSLauncher"),
    ...
    compileCss := Def.taskDyn {
      ...
      dir.mkdirs()
      (backend / Compile / runMain).toTask(s" org.wongiseng.backend.css.CssRenderer $path false")
    }.value,
