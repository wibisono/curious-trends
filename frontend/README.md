...
* `org.wongiseng.frontend.routing` - all the code related to the frontend application routing.
* `org.wongiseng.frontend.services` - the business logic of the client application.
* `org.wongiseng.frontend.views` - the code describing views and their behaviour.

The root package (`org.wongiseng.frontend`) also contains `JSLauncher` and `ApplicationContext`. The former 
