...
* `org.wongiseng.shared.css` - definition of application stylesheets.
* `org.wongiseng.shared.i18n` - definition of translations used in the application.
* `org.wongiseng.shared.model` - model classes which are useful in the RPC communication.
* `org.wongiseng.shared.rpc` - RPC interfaces for bidirectional client-server communication.
